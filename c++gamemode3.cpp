...
int main()
{
	...
	cout<<"-----Welcome To Ganesh Programming Environment ------";
	system("cls");
	cout<<"bullet types 1->invisible bullet 2-> * bullet....Press Enter to proceed";
	c=getchar();
	if(c=='\n')
	         {
       	   system("cls");
	        cout<<"Player 1 enter your bullet type\t";
			  cin>>b1;
			  switch(b1){ case 1:ponebullet=' '; break; case 2:ponebullet='*'; break; default:ponebullet='?';    }
			cout<<"Player 2 enter your bullet type\t";
			  cin>>b2;
			   switch(b2){ case 1:ptwobullet=' '; break; case 2:ptwobullet='*'; break; default:ptwobullet='?';    }
			   }
			   system("cls");
	...
	GameInfo.PlayerOnePosition.X =px1;
	GameInfo.PlayerOnePosition.Y =py1;
	GameInfo.PlayerTwoPosition.X =px2;
	GameInfo.PlayerTwoPosition.Y =py2;
